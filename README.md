...
[`linguonnx`](https://github.com/TigreGotico/linguonnx), which runs the
...
- [linguonnx](https://github.com/TigreGotico/linguonnx) - the detection engine
  this plugin wraps.
- [TigreGotico/glotlid-onnx](https://huggingface.co/TigreGotico/glotlid-onnx) -
  the ONNX export of GlotLID that `linguonnx` runs.
